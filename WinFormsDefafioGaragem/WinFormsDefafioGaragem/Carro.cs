...
namespace WinFormsDefafioGaragem
{
    public class Carro : Veiculo
    {
        ...
        public Carro(String veiculo, String placa, String horaEntrada, String dataEntrada) : base(placa, horaEntrada, dataEntrada)
        {
            Veiculo = veiculo;
        }

        public Carro(String veiculo, String placa, String tempoPermanencia, double valorCobrado) : base(placa, tempoPermanencia, valorCobrado)
        {
            Veiculo = veiculo;
        }
