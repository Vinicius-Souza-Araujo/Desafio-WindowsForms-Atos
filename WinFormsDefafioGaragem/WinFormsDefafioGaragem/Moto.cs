...
namespace WinFormsDefafioGaragem
{
    public class Moto : Veiculo
    {
        ...
        public Moto(String veiculo, String placa, String horaEntrada, String dataEntrada): base(placa,horaEntrada,dataEntrada)
        {
            Veiculo = veiculo;
        }

        public Moto(String veiculo, String placa, String tempoPermanencia, double valorCobrado) : base(placa, tempoPermanencia, valorCobrado)
        {
            Veiculo = veiculo;
        }
